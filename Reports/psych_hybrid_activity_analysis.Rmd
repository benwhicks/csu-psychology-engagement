...
soc_cluster_act_plot + 
  ggtitle('Social Psychology Site Activity', subtitle = 'By cluster, time running left to right')
bio_cluster_act_plot + 
  ggtitle('Biopsychology Site Activity', subtitle = 'By cluster, time running left to right')
```
