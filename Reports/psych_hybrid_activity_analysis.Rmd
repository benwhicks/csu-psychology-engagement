...
bio_clusters <- min(nodesBio$cluster, na.rm = T):max(nodesBio$cluster, na.rm = T)
...
rm(soc_act_item_intervals)

saveRDS(soc_act_item_intervals_n, 'soc_act_item_intervals_n.rds')
```
...
soc_act_item_intervals_n <- readRDS('soc_act_item_intervals_n.rds')
