...
socpsyAct18 <- read_csv(paste0(datdir, "aa Social Psychology 201860.csv"), col_types = "fTcccccccf")
biopsyAct18 <- read_csv(paste0(datdir, "aa Biopsychology 201860.csv"), col_types = "fTcccccccf")
courseContents <- read_csv(paste0(datdir, "psy course contents.csv"),
                           col_types = "ccfccccccc")
...
courseContents <- courseContents %>% mutate(forum_bool = if_else(is.na(forum_bool), NA, forum_bool))

socpsyAct18 <- merge(socpsyAct18, courseContents %>% select(cc_pk1, title, type, content_data, forum_bool), all.x = T)
biopsyAct18 <- merge(biopsyAct18, courseContents %>% select(cc_pk1, title, type, content_data, forum_bool), all.x = T)
