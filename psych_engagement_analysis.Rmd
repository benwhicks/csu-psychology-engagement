...
nodeMatrix <- make_normed_matrix(rbind(nodesBio, nodesSoc))

jet.colors <-     colorRampPalette(c("#00007F", "blue", "#007FFF", "cyan",
            "#7FFF7F", "yellow", "#FF7F00", "red", "#7F0000"))

make_dend <- function(x, metric = "euclidian") {
  as.dendrogram(hclust(dist(x, method = metric)))
}

draw_dendrogram <- function(x, dist_metric = "euclidian", clust_k = 4) {
  # x is a normed numeric matrix, like those made above
...
draw_dendrogram(nodeMatrix, clust_k = 6)
```
