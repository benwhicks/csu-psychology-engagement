...
socpsyAct18 <- read_csv(file.path(DATDIR, SOCAAFILE), col_types = "ffTcccccffcccf") 
socpsyAct18 <- tidyAA(socpsyAct18)

biopsyAct18 <- read_csv(file.path(DATDIR, BIOAAFILE), col_types = "ffTcccccffcccf")
...
marksSoc18 <- marksSummary18 %>% filter(subject_name == "Social Psychology")
marksBio18 <- marksSummary18 %>% filter(subject_name == "Biopsychology")
...
# Node assembly
# nodeData needs the fields:
# ID, Name, Role, Grade, Subject, Accesses, Interactions --- replace this with other stuff, 
